        ...
        <div class="board_wrapper"> 
            ...
            <div class="write_contents_wrapper">
                <div class="table_search">
                    <form action="write_db.php?user_id=<?php echo $user_id ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="field">
                            <textarea name="content" id="summernote" class="write_content"> </textarea>
                        </div>
